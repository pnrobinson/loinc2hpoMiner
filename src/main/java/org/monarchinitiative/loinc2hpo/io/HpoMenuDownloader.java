...
public class HpoMenuDownloader extends Task<Void>  {
    ...
    private final String localHpoHjsonPath;

    public HpoMenuDownloader(String loinc2hpoDirectory) {
        String HP_JSON = "hp.json";
        this.localHpoHjsonPath = loinc2hpoDirectory + File.separator + HP_JSON;
    }


    public void downloadHpo(String dest) throws Loinc2HpoRunTimeException {
        try {
