...
public class Loinc2HpoApplication extends Application {
    private ConfigurableApplicationContext applicationContext;

    static public final String FENOMINAL_NAME_KEY = "loinc2hpo.name";

    static public final String FENOMINAL_VERSION_PROP_KEY = "loinc2hpo.version";
