...
//                .collect(Collectors.toList()).size() != 0;
    ...
    public static Map<LoincId, LoincPanel> getPanels(String path, ImmutableMap<LoincId, LoincEntry> loincEntryMapX) throws IOException, Loinc2HpoRunTimeException {
        loincEntryMap = loincEntryMapX;
...
//                }
        ...
        if (!invalidPanelId.isEmpty()) {
            ...
            throw new Loinc2HpoRunTimeException();
        }
    ...
    public static Map<LoincId, LoincPanel> deserializeLoincPanel(String path) throws IOException {
