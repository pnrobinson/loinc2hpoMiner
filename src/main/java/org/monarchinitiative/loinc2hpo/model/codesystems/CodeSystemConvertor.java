...
public class CodeSystemConvertor {
    ...
    public Code convertToInternalCode(Code code) throws Exception {
        System.out.println(code);
        if (!this.codeConversionmap.containsKey(code)) {
            throw new Exception("Could not find an internal code that match to: " + code.getSystem() + " " + code.getCode());
        }
