...
//        List<HPO_Class_Found> result = SparqlQuery.query_auto(name);
        List<HPO_Class_Found> result = List.of();
...
//        }
    ...
    private static class HPO_TreeView{
        private final HPO_Class_Found hpo_class_found;
...
//        changeColorLoincTableView();
     ...
     * {@link org.monarchinitiative.loinc2hpogui.github.GitHubLabelRetriever}. We only do this
